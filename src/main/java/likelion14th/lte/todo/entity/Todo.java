...
public class Todo extends BaseEntity {
    ...
    public static Todo create(User user, String description, boolean routineEnabled, LocalDate startDate,
                              LocalDate endDate, Category category, WeekEnum week)
    {
        Todo todo = new Todo();
        todo.user = user;
    ...
    public void update(String description, Category category, WeekEnum week, boolean routineEnabled,
